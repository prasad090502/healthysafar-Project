                    ...
                    <div class="tab-pane fade" id="subs-pane" role="tabpanel">
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($subscriptions as $sub): ?>
                                <?php
                                    // Expecting aggregate data from controller:
                                    // id, status, plan_title, plan_slug, start_date, end_date,
                                    // total_days, delivered_days, remaining_days,
                                    // cut_off_hour, postponement_used, postponement_limit,
                                    // upcoming_deliveries => [ ... ]
                                    $subId        = (int)($sub['id'] ?? 0);
                                    ...
                                    $totalDays    = (int)($sub['total_days'] ?? 0);
                                ...
                                <div class="hs-sub-card">
                                                ...
                                                <table class="hs-deliveries-table">
                                                    ...
                                                    <?php foreach ($upcoming as $del): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <?php if (in_array($dStatus, ['pending','out_for_delivery'], true)): ?>
                                                                    <!-- You will wire these forms/links to real routes -->
                                    ...
                                    <div class="hs-sub-footer">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="<?= site_url('customer/subscriptions/view/' . $subId) ?>"
                                               class="btn btn-outline-secondary btn-outline-soft">
